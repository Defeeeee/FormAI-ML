...
model = tf.keras.models.load_model('squat_model_tf2.h5')
...
def predict_squat(image_path):
    ...
    if features:
        ...
        output = model.predict(input_tensor)[0]  # Get the prediction probabilities for both classes
        print(output)
        probability = output[0]  # Probability of "Good Squat"
...
# Example usage
image_path = '/Users/defeee/Downloads/1000_F_125800311_BpdqcxzVCrAUVSMZENcGrV23ziSQ5T56.jpg'
