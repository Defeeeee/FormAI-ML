...
from Feedback.Plank_nn.plank_feedback import classify
...
@app.get('/analyze_plank_nn')
def analyze_plank_nn(video_path: str | None = None):
    if video_path is None:
        return {'error': 'Please provide a video path'}
